            ...
            <div className="p-8 md:p-12 space-y-8">
              ...
              <div className="space-y-4">
                {offerItems.map((item, index) => (
                  <div 
                    key={index}
                    className="flex items-center justify-between p-4 rounded-lg bg-secondary/30 border border-border hover:border-primary/30 transition-all group"
                  >
                    <div className="flex items-center gap-4 flex-1">
                      <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                ...
                <div className="relative p-6 rounded-xl bg-gradient-to-r from-primary/20 to-primary/10 border-2 border-primary shadow-[0_0_30px_hsl(92,100%,52%,0.3)] animate-glow">
                  <div className="absolute -top-3 left-6">
                    <span className="px-4 py-1 bg-primary text-primary-foreground font-display font-bold text-xs uppercase tracking-wider rounded-full">
                      BÔNUS EXCLUSIVO
                    </span>
                  </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-display font-bold text-2xl text-muted-foreground line-through">
                    R$ 18.500
                  </span>
                </div>

                <div className="flex items-center justify-between p-6 rounded-xl bg-primary/10 border-2 border-primary">
