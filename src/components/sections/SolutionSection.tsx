...
export const SolutionSection = () => {
  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-secondary/20 to-background relative">
      <div className="container px-4">
        <div className="mx-auto max-w-6xl space-y-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Lado 1 - O Erro (Falha) */}
            <Card className="bg-destructive/5 border-destructive/30 p-8 relative overflow-hidden">
              ...
              <div className="space-y-6">
                <h3 className="font-display font-bold text-2xl text-destructive">
            ...
            <Card className="bg-primary/5 border-primary/30 p-8 relative overflow-hidden shadow-[0_0_40px_hsl(92,100%,52%,0.1)]">
              <div className="absolute top-4 right-4">
          ...
          <div className="space-y-12">
            <div className="text-center">
              <h3 className="font-display font-bold text-2xl md:text-4xl text-foreground mb-2">
                Nosso Acelerador não são "Aulas",
              </h3>
              <h3 className="font-display font-bold text-2xl md:text-4xl text-primary">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {sprintCards.map((sprint, index) => (
                <Card 
                  key={index}
                  className="bg-card/50 backdrop-blur-sm border-border hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_30px_hsl(92,100%,52%,0.15)] p-8 group"
                >
                  <div className="space-y-6">
                    {/* Icon & Month Badge */}
                    <div className="flex items-center justify-between">
                      <div className="h-14 w-14 rounded-xl bg-primary/10 border-2 border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <sprint.icon className="h-7 w-7 text-primary" strokeWidth={2} />
                      </div>
                      <span className="text-xs font-display font-bold text-primary uppercase tracking-wider px-3 py-1 rounded-full bg-primary/10 border border-primary/30">
                        {sprint.month}
                      </span>
                    </div>
